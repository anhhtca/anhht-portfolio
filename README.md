<div align="center">
    <a href="https://anhht.me"><h1 align="center">anhht.me</h1></a>

My personal website, built with [Next.js](https://nextjs.org/), [Tailwind CSS](https://tailwindcss.com/), [Upstash](https://upstash.com?ref=anhht.me), [Contentlayer](https://www.contentlayer.dev/) and deployed to [Vercel](https://vercel.com/).
...
```sh-session
git clone https://github.com/chronark/anhht.me.git
cd anhht.me
```

Create a `.env` file similar to [`.env.example`](https://github.com/chronark/anhht.me/blob/main/.env.example).
