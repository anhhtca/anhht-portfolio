...
function Contact(_, ref) {
  ...
  const missinInfoMessage = () => {
    const base =
      "You have to provide at least your name, a valid email, and a message to be able to write you back.";
    const missingName = !nameField.value ? "You are missing your name." : "";
    const missingEmail = !validEmail(emailField.value)
      ? "Its not a valid email."
      : "";
    const missingMessage = !messageField.value
      ? "You are missing your message."
      : "";

    return [base, missingName, missingEmail, missingMessage]
      .filter(Boolean)
      .join("\n");
  };
      ...
      <div className={styles.contactContainer}>
        <div className={styles.messageForm}>
          ...
          <form id="contact-form">
            <div>
              <label htmlFor="name" className={styles.screenReaderOnly}>
                Name
              </label>
              <input {...nameField} />
            </div>
            ...
            <div>
              <label htmlFor="subject" className={styles.screenReaderOnly}>
                Subject
              </label>
              <input {...subjectField} />
            </div>
            <div>
              <label htmlFor="message" className={styles.screenReaderOnly}>
                Message
              </label>
            ...
            <input
              ...
              className={`${buttonStyles.btn} ${buttonStyles.btnPrimary} ? ${
                !isValidForm() ? buttonStyles.btnDisabled : ""
              }`}
              value="Send Email"
              onClick={sendEmail}
            />
        ...
        <div className={styles.socialMedia}>
          ...
          <p>
            If you wanna know more about me, you can leave a comment, or write
            me an email. Also, you can find me in the internet, usually as
          </p>
          <p className={styles.primaryText}>AnhLEGO</p>
          <ul className={styles.socialList}>
            <li>
              <FaLinkedinIn aria-label="LinkedIn" />
              <a
                target="_blank"
                href={data.socialLinkedinUrl}
            ...
            <li>
              ...
              <a href={`mailto:${data.socialEmail}`}>{data.socialEmail}</a>
            </li>
            <li>
              <FaMapMarkerAlt aria-label="Location" />
              <a
                target="_blank"
                href="https://www.google.com/maps/place/Santiago,+Santiago+Metropolitan+Region,+Chile/@-33.7201586,-75.43648,5z"
                rel="noopener noreferrer"
              >
