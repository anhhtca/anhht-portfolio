export const siteConfig = {
  name: "Hoàng Tuấn Anh - Applied AI Engineer",
  authorName: "Hoàng Tuấn Anh",
  username: "namanbarkiya",
  description:
    "Hoàng Tuấn Anh - Applied AI Engineer working at the intersection of AI, data, and scalable software systems. Explore my projects, experience, and contributions in software development and AI.",
